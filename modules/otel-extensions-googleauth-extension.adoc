...
# ...
----
<1> The extension sends telemetry to the Google Cloud project that you specify by using this field, which is as an alternative to using the `gcp.project.id` resource attribute. If you do not specify a Google Cloud project by using this field, the extension gets it by using the application default credentials.
