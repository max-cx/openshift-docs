...
. Create an OpenShift project of your choice for the *TempoStack* instance that you will create in the next step.
+
...
. Go to *Operators* -> *Installed Operators* to verify that the *Status* of the TempoStack is *Condition: Ready*.
