...
= Migrating from the {JaegerName} to the {OTELName} with sidecars

The {OTELName} Operator supports sidecar injection into Deployment workloads, so you can migrate from a {JaegerName} sidecar to a {OTELName} sidecar.
