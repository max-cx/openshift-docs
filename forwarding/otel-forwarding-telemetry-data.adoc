...
* https://docs.cloud.google.com/stackdriver/docs/managed-prometheus[Google Cloud Managed Service for Prometheus]
* https://docs.cloud.google.com/iam/docs/workload-identity-federation-with-kubernetes[Configure Workload Identity Federation with Kubernetes]
