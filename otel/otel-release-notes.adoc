...
Curently, cluster monitoring of the {OTELOperator} is disabled (link:https://issues.redhat.com/browse/TRACING-3761[TRACING=3139]). You can enable monitoring manually by adding an annotation in the Operator namespace and creating a service monitor.
