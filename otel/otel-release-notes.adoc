...
* The *OpenShift distributed tracing data collection* Operator is renamed to the *{OTELOperator}*.
...
* In {OTELName} {DTProductVersion}, the Jaeger exporter is removed. Users are advised to switch to the OTLP exporter for sending data to the Jaeger collector.
