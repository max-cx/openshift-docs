...
This update introduces the following enhancements for {JaegerShortName}:
...
This update introduces the following bug fixes for {JaegerShortName}:
...
This update introduces the following enhancements for {TempoShortName}:
...
This update introduces the following bug fixes for {TempoShortName}:
