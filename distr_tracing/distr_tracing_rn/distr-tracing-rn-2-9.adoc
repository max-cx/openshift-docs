...
* Missing images for running the Operator in restricted environments. The {TempoName} CSV is missing references to the operand images. (link:https://issues.redhat.com/browse/TRACING-3173[TRACING-3523])
+
.Workaround
:!example-caption:
====
