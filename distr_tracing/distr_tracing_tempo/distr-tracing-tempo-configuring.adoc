...
The {TempoOperator} supports monitoring and alerting of each {TempoShortName} component (distributor, ingester, etc.) and exposes upgrade and operational metrics about the operator itself.
