...
The {OTELOperator} supports monitoring and alerting of each OpenTelemtry Collector instances and exposes upgrade and operational metrics about the Operator itself.
